...
const TeamListItem = (props) => {
    ...
    return (
          ...
          <div className={styles.teamOneContainer}>
              <img className={styles.stylingLogo} src={props.team.teamLogoUrl} alt="Team Logo"/>
              ...
              <div className={styles.teamDetailContainer}>
                  <Link className={styles.stylingLink} to={"./TeamDetail/"+ props.team.teamReference} alt="Team Name ">Team Detail</Link>
              </div>
           </div>  
